...
Each repo declares its own gated-dataset table in its local `.claude/rules/02-data-protection.md` (per-repo prefixes, gate type, what's safe to commit). Universal rules across any gated data:
